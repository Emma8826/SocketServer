    ...
    public void startServer(){
        try{
            while(!serverSocket.isClosed()){//while server socket is open,waitting client connected
                Socket socket = serverSocket.accept();//meaning our program will be halted here until a client connects
                ...
                //our application would only be able to handle one client at a time
